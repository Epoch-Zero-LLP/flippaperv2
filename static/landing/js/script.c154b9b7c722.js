jQuery(document).ready(function () {
    ...
    $("#js-swarn").change(function () {
        if ($(this).val() == "warn") {
            $("#js-swarnlevel").prop("disabled", false);
        } else {
            $("#js-swarnlevel").prop("disabled", true).val("").attr('data-empty', '');
        }
    });
    $("#js-sautos").change(function () {
        if ($(this).val() == "auto") {
            $("#js-sautoi").prop("disabled", false);
        } else {
            $("#js-sautoi").prop("disabled", true).val("").attr('data-empty', '');
        }
    });
    $("#js-cwarns").change(function () {
        if ($(this).val() == "warn") {
            $(".form__warningblock").addClass("form__warningblock--showed");
        } else {
            $(".form__warningblock").removeClass("form__warningblock--showed");
        }
    });
    ...
    $('.js-showform').click(function (e) {
        e.preventDefault();
        $('.contact').addClass('contact--showed');
        $('body').addClass('body--ovh');
        $.fn.fullpage.setAllowScrolling(false);
        $.fn.fullpage.setKeyboardScrolling(false);
    });
    $('.js-hideform').click(function (e) {
        e.preventDefault();
        $('.contact').removeClass('contact--showed');
        $('body').removeClass('body--ovh');
        $.fn.fullpage.setAllowScrolling(true);
        $.fn.fullpage.setKeyboardScrolling(true);
    });

    $('.js-showpopops').click(function (e) {
        e.preventDefault();
        $('.popops').addClass('popops--showed');
        $('body').addClass('body--ovh');
        $.fn.fullpage.setAllowScrolling(false);
        $.fn.fullpage.setKeyboardScrolling(false);
    });
    $('.js-hidepopops').click(function (e) {
        e.preventDefault();
        $('.popops').removeClass('popops--showed');
        $('body').removeClass('body--ovh');
        $.fn.fullpage.setAllowScrolling(true);
        $.fn.fullpage.setKeyboardScrolling(true);
    });
    ...
    $('.js-toppage').click(function () {
        $.fn.fullpage.moveTo(1);
    });

    $('.js-popShow').click(function (e) {
        e.preventDefault();
        $('.bandwidth-popup').addClass('bandwidth-popup--showed');
    });
    $(document).click(function (e) {
        if ($(e.target).closest('.js-popShow').length === 0) {
            $('.bandwidth-popup').removeClass('bandwidth-popup--showed');
        }
    });

    var sdf45 = new Swiper('.feauters-items-slider', {
        slidesPerView: 3,
        spaceBetween: 30,
        speed: 700,
        mousewheel: false,
        navigation: {
            nextEl: '.feauters-items-next',
            prevEl: '.feauters-items-prev',
        },
        breakpoints: {
    ...
    var dsf42 = new Swiper('.steps-items-slider', {
        slidesPerView: 2,
        spaceBetween: 0,
        speed: 700,
        mousewheel: false,
        navigation: {
            nextEl: '.steps-items-next',
            prevEl: '.steps-items-prev',
        },
        breakpoints: {
            700: {
                slidesPerView: 1,
    ...
    var dsf42 = new Swiper('.stages-items-slider', {
        slidesPerView: 3,
        spaceBetween: 0,
        speed: 700,
        mousewheel: false,
        navigation: {
            nextEl: '.stages-items-next',
            prevEl: '.stages-items-prev',
        },
        breakpoints: {
            700: {
                slidesPerView: 1,
    ...
    var asdw4312 = new Swiper('.servs-items-slider', {
        slidesPerView: 1,
        spaceBetween: 0,
        simulateTouch: false,
        speed: 1500,
        ...
        navigation: {
            nextEl: '.servs-items-next',
            prevEl: '.servs-items-prev',
        },
        on: {
            reachEnd: function(){
                $('.servs .swiper-pagination').addClass('swiper-pagination-hidden')
            }
        }
    });
    ...
    var dsf42 = new Swiper('.combidop-slider', {
        slidesPerView: 3,
        spaceBetween: 0,
        speed: 700,
        mousewheel: false,
        navigation: {
            nextEl: '.combidop-next',
            prevEl: '.combidop-prev',
        },
        breakpoints: {
            700: {
                slidesPerView: 1,
    ...
    $('.servs .swiper-button-prev').click( function(){
        $('.servs .swiper-pagination').removeClass('swiper-pagination-hidden')
    });
});
